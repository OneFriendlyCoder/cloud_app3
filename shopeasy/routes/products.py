...
def product_detail(product_id):
    ...
    from shopeasy.dynamodb import increment_product_view
    view_count = increment_product_view(product.id)
    return render_template("products/detail.html", product=product, view_count=view_count)
